import { normalizeWeather } from './weather.js?v=4.2';
import { validDate, validTimezone } from './time.js?v=4.2';
...
export function installBridge(onState, onReset, currentWindow = window) {
  ...
  const api = Object.freeze({ version: '4.2.0', setState: apply, reset: onReset });
